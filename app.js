...
function startApp() {
    inquirer.prompt({
        ...
        if (data.employeeType === "Manager") {
            ...
            var HTML = htmlGen(managerList, engineerList, internList)
...
function addManager() {
    ...
    inquirer.prompt([
        ...
        managerList.push(newManager.getCard())
        // Restart the app
...
function addEngineer() {
    ...
    inquirer.prompt([
        ...
        engineerList.push(newEngineer.getCard())
        // Restart the app
        console.log("Add another Employee?")
        startApp()
    })
...
function addIntern() {
    ...
    inquirer.prompt([
        ...
        internList.push(newIntern.getCard())
        // Restart the app
        console.log("Add another Employee?")
        startApp()
    })
...
function htmlGen(managers, engineers, interns) {
    return `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
